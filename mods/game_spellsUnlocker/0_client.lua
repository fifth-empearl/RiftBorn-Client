...
SpellsUnlocker.categoryIcons = {
	Attack = "images/categories/attackIcon",
	Conjuring = "images/categories/convinceIcon",
	Healing = "images/categories/healingIcon",
	Support = "images/categories/supportIcon",
}

SpellsUnlocker.spellIconFolders = {
	[1] = "sorcerer",
	[2] = "druid",
	[3] = "knight",
	[4] = "paladin",
...
SpellsUnlocker.categoryIconFolders = {
	[1] = "attack",
	[2] = "support",
	[3] = "healing",
	[4] = "conjuring",
